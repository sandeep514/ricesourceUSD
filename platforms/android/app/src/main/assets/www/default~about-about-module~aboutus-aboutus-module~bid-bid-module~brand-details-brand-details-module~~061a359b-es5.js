...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~about-about-module~aboutus-aboutus-module~bid-bid-module~brand-details-brand-details-module~~061a359b"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppMenuMenuComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<ion-row class=\"ion-no-padding footer-tabs\">\n\t<ion-col class=\"ion-no-padding\">\n\t\t\t<div class=\"example1\">\n\t\t\t\t<h3>Scrolling text... </h3>\n\t\t\t</div>\n\t\t<ion-row class=\"tabs-row\">\n\t\t\t<ng-container *ngIf=\"apptype == 'OTHER' \">\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t(click)=\"goTo((apptype != 'USD')? 'prices' :'priceusd' )\">\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/liveprice.svg\" />\n\t\t\t\t\t<h5>Live Prices</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" (click)=\"goTo('buy-inr')\">\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/transport.png\" class=\"truck\" style=\"width: 60px !important\" />\n\t\t\t\t\t<h5>Buy</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" (click)='goTo(\"trade-inr\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/trade.svg\" />\n\t\t\t\t\t<h5>Trade</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" (click)='goTo(\"selling-inr\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/chaat.png\" />\n\t\t\t\t\t<h5>Sell</h5>\n\t\t\t\t</ion-col>\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" (click)='goTo(\"brands\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/chaat.png\" />\n\t\t\t\t\t<h5>Brand</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" (click)='openModel()'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/menu.svg\" />\n\t\t\t\t\t<h5>Menu</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t</ng-container>\n\n\t\t\t<ng-container *ngIf=\"apptype != 'OTHER' \">\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t(click)=\"goTo((apptype != 'USD')? 'prices' :'priceusd' )\">\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<!-- <img src=\"../../assets/menu/live prices.png\" *ngIf=\"apptype != 'USD'\" />\n\t\t\t\t\t<img src=\"../../assets/menu/doller.png\" *ngIf=\"apptype == 'USD'\" /> -->\n\t\t\t\t\t<img src=\"../../assets/menu/liveprice.svg\" />\n\n\t\t\t\t\t<h5>Live Prices</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t*ngIf=\"isCurrentUser == 'false' && apptype == 'USD'\" (click)=\"goTo('oceanfreights')\">\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/images-removebg-preview.png\" class=\"truck\"\n\t\t\t\t\t\tstyle=\"width: 39px !important\" />\n\t\t\t\t\t<h5>Ocean Freight</h5>\n\t\t\t\t</ion-col>\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" *ngIf=\"seledctedRole == 5 && apptype == 'USD' \"\n\t\t\t\t\talign=\"center\" (click)='goTo(\"buy\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/486-4865980_shopping-cart-png-vector-shopping-cart-png-transparent-removebg-preview.png\"\n\t\t\t\t\t\tstyle=\"width: 34px !important\" />\n\t\t\t\t\t<h5>Buy </h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t*ngIf=\"seledctedRole == 4 || seledctedRole == 6 || seledctedRole == 7  && apptype == 'USD'\"\n\t\t\t\t\t(click)='goTo(\"calculator\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/calculator.png\" style=\"width: 21px !important\" />\n\t\t\t\t\t<h5>Calculator</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t*ngIf=\"seledctedRole == 5  && apptype == 'USD'\" (click)='goTo(\"hotdeals\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/fire-sign-fire-flame-icon-isolated-on-white-background-illustration-free-vector-removebg-preview.png\"\n\t\t\t\t\t\tstyle=\"width: 34px !important\" />\n\t\t\t\t\t<h5>Hot Deals</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<!-- <ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" *ngIf=\" isCurrentUser == 'false' \" (click)='goTo(\"gallery\")'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/gallery.png\" />\n\t\t\t\t\t<h5>Gallery</h5>\n\t\t\t\t</ion-col> -->\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\"\n\t\t\t\t\t*ngIf=\"seledctedRole == 4 || seledctedRole == 6 || seledctedRole == 7 && apptype == 'USD'\"\n\t\t\t\t\t(click)='goToBids()'>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/offers.png\" style=\"width: 27px;\" />\n\t\t\t\t\t<h5>Offer</h5>\n\t\t\t\t</ion-col>\n\n\t\t\t\t<ion-col class=\"tab-icon ion-activatable ripple-parent\" align=\"center\" *ngIf=\"apptype == 'USD'\"\n\t\t\t\t\t(click)=\"goTo('otherservices')\" menuToggle>\n\t\t\t\t\t<ion-ripple-effect type=\"unbounded\"></ion-ripple-effect>\n\t\t\t\t\t<img src=\"../../assets/menu/images__1_-removebg-preview.png\" style=\"width: 27px;\" />\n\t\t\t\t\t<h5>Other services</h5>\n\t\t\t\t</ion-col>\n\t\t\t</ng-container>\n\n\t\t</ion-row>\n\t\t<button style=\"display: none;\" id=\"clickButton\" (click)=\"updateNotification()\">kjhnj</button>\n\t\t<button style=\"display: none;\" id=\"clickButtonforPayment\" (click)=\"clickButtonforPayment()\">kjhnj</button>\n\t</ion-col>\n</ion-row>";
  ...
  function srcAppMenuMenuComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MenuComponent = /*#__PURE__*/function () {
      function MenuComponent(compSer, navCtrl, menuCtrl, restApi, ModelCtrl, toastCtrl) {
        var _this = this;

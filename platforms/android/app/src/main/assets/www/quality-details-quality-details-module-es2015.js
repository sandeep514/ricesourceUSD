...
let QualityDetailsPage = class QualityDetailsPage {
    ...
    getAllCountryPorts(riceQualityId) {
        this.componentService.presentLoading().then(() => {
            this.apiser.getAllPorts(riceQualityId).then((res) => {
                ...
                this.regions = Object.keys(res.ports);
    ...
    changeBag(data) {
        let modifiedAmount = parseFloat(data.detail.value).toFixed(2);
    ...
    changeRegion(data) {
        ...
        this.country = Object.keys(this.ports[region]);
    }
    changeCountry(data) {
        ...
        this.selectedPorts = Object.keys(this.selectedPorts);
    }
    changePort(data) {

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ricechart-ricechart-module"], {
  /***/
    ...
    (function (X, N) {
      ...
      N(m, "Core/Utilities.js", [m["Core/Globals.js"]], function (f) {
        ...
        function K(b, k) {
          ...
          for (b = t.pop(); "undefined" !== typeof b && "undefined" !== typeof k && null !== k;) {
            k = k[b], b = t.pop();
          }
        ...
        var Y = f.addEvent = function (b, k, t, a) {
          ...
          if (y.createEvent && (b.dispatchEvent || b.fireEvent)) {
            ...
            for (u = 0; u < d; u++) {
              !1 === (k[c] ? a[H] ? k[c].order <= a[H].order ? k[c++] : a[H++] : k[c++] : a[H++]).fn.call(b, t) && t.preventDefault();
            }
        ...
        h = function () {
          ...
          h.prototype.brighten = function (f) {
            ...
            if (this.stops) this.stops.forEach(function (e) {
              e.brighten(f);
            });else if (m(f) && 0 !== f) for (h = 0; 3 > h; h++) {
              y[h] += F(255 * f), 0 > y[h] && (y[h] = 0), 255 < y[h] && (y[h] = 255);
            }
            return this;
          };
      ...
      N(m, "Core/Animation/AnimationUtilities.js", [m["Core/Animation/Fx.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m) {
        ...
        var v = h.animObject = function (l) {
          ...
          for (var w = h.timers.length; w--;) {
            h.timers[w].elem !== l || n && n !== h.timers[w].prop || (h.timers[w].stopped = !0);
          }
        };
      ...
      N(m, "Core/Renderer/SVG/SVGElement.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m, z) {
        ...
        f = function () {
          ...
          E.prototype.destroy = function () {
            ...
            for (k.styledMode || a.destroyShadows(); t && t.div && 0 === t.div.childNodes.length;) {
              b = t.parentGroup, a.safeRemoveChild(t.div), delete t.div, t = b;
            }
          ...
          E.prototype.removeTextOutline = function (a) {
            for (var b = a.length, k; b--;) {
              k = a[b], "highcharts-text-outline" === k.getAttribute("class") && d(a, this.element.removeChild(k));
            }
          };
          ...
          E.prototype.setTextPath = function (a, b) {
            ...
            if (a && b && b.enabled) {
              ...
              if (g) for (a = k.getElementsByTagName("tspan"); a.length;) {
                a[0].setAttribute("y", 0), p(q.dx) && a[0].setAttribute("x", -q.dx), u.appendChild(a[0]);
              }
              c && d && d.add({
          ...
          E.prototype.updateShadows = function (a, b, k) {
            var t = this.shadows;
            if (t) for (var c = t.length; c--;) {
              k.call(t[c], "height" === a ? Math.max(b - (t[c].cutHeight || 0), 0) : "d" === a ? this.d : b, a, t[c]);
            }
          };
      ...
      N(m, "Core/Renderer/SVG/SVGRenderer.js", [m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Renderer/SVG/SVGLabel.js"], m["Core/Utilities.js"]], function (f, h, m, z, F) {
        ...
        var M = h.svg,
          ...
          u.prototype.truncate = function (b, k, a, c, d, g, q) {
            ...
            if (e = d + w > g) {
              for (; u <= A;) {
                r = Math.ceil((u + A) / 2), c && (R = q(c, r)), w = l(r, R && R.length - 1), u === A ? u = A + 1 : w > g ? A = r - 1 : u = r;
              }
                  ...
                  if ("" !== t || 1 === q.length) {
                    ...
                    if (" " !== t) {
                      ...
                      if (e) {
                        ...
                        });else if (R) for (; w.length;) {
                          w.length && !E && 0 < l && (u = p.createElementNS(T, "tspan"), K(u, {
                            dy: r,
                            x: B
      ...
      N(m, "Core/Time.js", [m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h) {
        ...
        h = function () {
          ...
          h.prototype.dateFormat = function (n, l, h) {
            ...
            C(w, function (a, c) {
              for (; -1 !== n.indexOf("%" + c);) {
                n = n.replace("%" + c, "function" === typeof a ? a.call(r, l) : a);
              }
            });
          ...
          h.prototype.getTimeTicks = function (n, l, f, h) {
            ...
            if (m(l)) {
              ...
              for (c = 1; l < f;) {
                d.push(l), l = a === v.year ? r.makeTime(B + c * q, 0) : a === v.month ? r.makeTime(B, h + c * q) : !p || a !== v.day && a !== v.week ? p && a === v.hour && 1 < q ? r.makeTime(B, h, A, w + c * q) : l + a * q : r.makeTime(B, h, A + c * q * (a === v.day ? 1 : 7)), c++;
              }
      ...
      N(m, "Core/Axis/Axis.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Axis/Tick.js"], m["Core/Utilities.js"], m["Core/Options.js"]], function (f, h, m, z, F, L) {
        ...
        f = function () {
          ...
          u.prototype.defaultLabelFormatter = function () {
            ...
            var B = this.chart,
                l = B.numberFormatter;
            if (u) var A = w(u, this, B);else if (d) A = "" + this.value;else if (g) A = a.dateFormat(g, k);else if (e && 1E3 <= b) for (; e-- && "undefined" === typeof A;) {
              a = Math.pow(p, e + 1), b >= a && 0 === 10 * k % a && null !== q[e] && 0 !== k && (A = l(k / a, -1) + q[e]);
            }
          ...
          u.prototype.getMinorTickPositions = function () {
            ...
            if (q && q / c < this.len / 3) {
              ...
              });else if (this.dateTime && "auto" === this.getMinorTickInterval()) d = d.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(c), p, g, b.startOfWeek));else for (b = p + (a[0] - p) % c; b <= g && b !== d[0]; b += c) {
                d.push(b);
              }
            }
          ...
          u.prototype.trimTicks = function (b, a, c) {
            ...
            if (!this.isLinked) {
              if (a && -Infinity !== k) this.min = k;else for (; this.min - t > b[0];) {
                b.shift();
              }
              if (c) this.max = d;else for (; this.max + t < b[b.length - 1];) {
                b.pop();
              }
            ...
            if (this.hasData()) {
              if (p < d) {
                for (e = this.min; c.length < d;) {
                  c.length % 2 || e === q ? c.push(v(c[c.length - 1] + a)) : c.unshift(v(c[0] - a));
                }
              ...
              if (x(g)) {
                for (a = b = c.length; a--;) {
                  (3 === g && 1 === a % 2 || 2 >= g && 0 < a && a < b - 1) && c.splice(a, 1);
                }
          ...
          u.prototype.render = function () {
            ...
            [u, l, r].forEach(function (b) {
              ...
              Q(function () {
                for (c = k.length; c--;) {
                  b[k[c]] && !b[k[c]].isActive && (b[k[c]].destroy(), delete b[k[c]]);
                }
          ...
          u.prototype.destroy = function (b) {
            ...
            for (d in a.plotLinesAndBandsGroups) {
              a.plotLinesAndBandsGroups[d] = a.plotLinesAndBandsGroups[d].destroy();
            }
      ...
      N(m, "Core/Axis/PlotLineOrBand.js", [m["Core/Axis/Axis.js"], m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h, m) {
        ...
        y(f.prototype, {
          ...
          removePlotBandOrLine: function removePlotBandOrLine(e) {
            for (var f = this.plotLinesAndBands, n = this.options, l = this.userOptions, h = f.length; h--;) {
        ...
        f = function () {
          ...
          f.prototype.optionsToObject = function (e) {
            var d = {},
                ...
                p = 0,
                n = 0;
            if (v(e) || null === e) d[a[0]] = e;else if (I(e)) for (!c && e.length > l && (g = typeof e[0], "string" === g ? d.name = e[0] : "number" === g && (d.x = e[0]), p++); n < l;) {
      ...
      N(m, "Core/Chart/Chart.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Axis/Axis.js"], m["Core/Series/Series.js"], m["Core/Globals.js"], m["Core/Legend.js"], m["Core/MSPointer.js"], m["Core/Options.js"], m["Core/Pointer.js"], m["Core/Time.js"], m["Core/Utilities.js"]], function (f, h, m, z, F, L, K, C, y, e) {
        var I = f.animate,
          ...
          f.prototype.temporaryDisplay = function (a) {
            var b = this.renderTo;
            if (a) for (; b && b.style;) {
              b.hcOrigStyle && (g(b, b.hcOrigStyle), delete b.hcOrigStyle), b.hcOrigDetached && (n.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode;
            } else for (; b && b.style;) {
      ...
      N(m, "Core/Series/CartesianSeries.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Series/Series.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Core/Options.js"], m["Core/Series/Point.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Utilities.js"]], function (f, h, m, z, F, L, K, C) {
        ...
        f = h.seriesType("line", void 0, {
            ...
            if (!O) {
              ...
              if (n && t > n) {
                if (n = k.getFirstValidPoint(b), p(n)) for (d = 0; d < t; d++) {
                  ...
                  } else for (v && (E = v.indexOf("x"), H = v.indexOf("y"), E = 0 <= E ? E : 0, H = 0 <= H ? H : 1), d = 0; d < t; d++) {
                    g = b[d], r[d] = g[E], m[d] = g[H];
                  }
                } else w(12, !1, h);
              } else for (d = 0; d < t; d++) {
                "undefined" !== typeof b[d] && (g = {
                  series: k
          ...
          getProcessedData: function getProcessedData(a) {
            ...
            for (p = b.length || 1; --p;) {
              if (d = f ? a(b[p]) - a(b[p - 1]) : b[p] - b[p - 1], 0 < d && ("undefined" === typeof m || d < m)) var m = d;else 0 > d && q && (w(15, !1, this.chart), q = !1);
            }
          ...
          generatePoints: function generatePoints() {
            ...
            this.options.keys = a;
            if (d && (h !== (e = d.length) || n)) for (m = 0; m < e; m++) {
              m !== q || n || (m += h), d[m] && (d[m].destroyElements(), d[m].plotX = void 0);
            }
            this.data = d;
            this.points = u;
      ...
      N(m, "Core/Dynamics.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Axis/Axis.js"], m["Core/Series/Series.js"], m["Core/Chart/Chart.js"], m["Core/Globals.js"], m["Series/LineSeries.js"], m["Core/Options.js"], m["Core/Series/Point.js"], m["Core/Time.js"], m["Core/Utilities.js"]], function (f, h, m, z, F, L, K, C, y, e) {
        ...
        g(L.prototype, {
          addPoint: function addPoint(a, d, g, b, e) {
            ...
            var m = u.x;
            var r = l.length;
            if (this.requireSorting && m < l[r - 1]) for (n = !0; r && l[r - 1] > m;) {
              r--;
            }
        ...
        g(h.prototype, {
          ...
          remove: function remove(c) {
            for (var d = this.chart, g = this.coll, b = this.series, e = b.length; e--;) {
              b[e] && b[e].remove(!1);
            }
              ...
              h.forEach(function (a, e) {
                ...
                if (l[a] && !l[a].isNull) f.push(l[a]), [-1, 1].forEach(function (f) {
                  var p = 1 === f ? "rightNull" : "leftNull",
                      m = 0,
                      v = n[h[e + f]];
                  if (v) for (g = y; 0 <= g && g < r;) {
                    q = v.points[g], q || (g === y ? l[a][p] = !0 : c[g] && (w = n[a].points[g]) && (m -= w[1] - w[0])), g += d;
                  }
      ...
      N(m, "Mixins/CenteredSeries.js", [m["Core/Globals.js"], m["Core/Utilities.js"]], function (f, h) {
        ...
        return f.CenteredSeriesMixin = {
          getCenter: function getCenter() {
            ...
            for (v = 0; 4 > v; ++v) {
              D = h[v], m = 2 > v || 2 === v && /%$/.test(D), h[v] = F(D, [e, I, x, h[2]][v]) + (m ? y : 0);
            }
      ...
      N(m, "Series/PieSeries.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Series/Series.js"], m["Mixins/CenteredSeries.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Series/LineSeries.js"], m["Core/Series/Point.js"], m["Core/Renderer/SVG/SVGRenderer.js"], m["Core/Utilities.js"]], function (f, h, m, z, F, L, K, C, y) {
        ...
        h.seriesType("pie", "line", {
          ...
          updateTotals: function updateTotals() {
            ...
            for (d = 0; d < a; d++) {
              f = c[d], f.percentage = 0 < g && (f.visible || !e) ? f.y / g * 100 : 0, f.total = g;
            }
          },
          generatePoints: function generatePoints() {
      ...
      N(m, "Core/Series/DataLabels.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Globals.js"], m["Core/Series/CartesianSeries.js"], m["Core/Utilities.js"]], function (f, h, m, z) {
        ...
        h.distribute = function (d, e, c) {
          ...
          for (d = d.map(function (a) {
            ...
            for (f = d.length; f--;) {
              g = d[f], v = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2, g.pos = C(v - g.size * g.align, 0, e - g.size);
            }

            f = d.length;

            for (g = !1; f--;) {
              0 < f && d[f - 1].pos + d[f - 1].size > d[f].pos && (d[f - 1].size += d[f].size, d[f - 1].targets = d[f - 1].targets.concat(d[f].targets), d[f - 1].align = .5, d[f - 1].pos + d[f - 1].size > e && (d[f - 1].pos = e - d[f - 1].size), d.splice(f, 1), g = !0);
            }
          }
        ...
        m.prototype.drawDataLabels = function () {
          ...
          function e(a, c) {
            ...
            if (x(a) && !x(c)) d = a.map(function (a) {
              ...
              return D(a, b);
            });else if (x(a) || x(c)) for (b = Math.max(a.length, c.length); b--;) {
              d[b] = D(a[b], c[b]);
            } else d = D(a, c);
            return d;
          }
      ...
      N(m, "Core/Responsive.js", [m["Core/Chart/Chart.js"], m["Core/Utilities.js"]], function (f, h) {
        ...
        f.prototype.currentOptions = function (e) {
          function f(e, l, m, v) {
            var n;
            K(e, function (d, e) {
              if (!v && -1 < h.collectionsWithUpdate.indexOf(e)) for (d = y(d), m[e] = [], n = 0; n < Math.max(d.length, l[e].length); n++) {
                l[e][n] && (void 0 === d[n] ? m[e][n] = l[e][n] : (m[e][n] = {}, f(d[n], l[e][n], m[e][n], v + 1)));
  ...
  function srcAppRicechartRicechartRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_require__.d(__webpack_exports__, "RicechartPageRoutingModule", function () {
      return RicechartPageRoutingModule;
    });
    /* harmony import */
    ...
    var _ricechart_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./ricechart.page */
    "./src/app/ricechart/ricechart.page.ts");

    var routes = [{
      path: '',
      component: _ricechart_page__WEBPACK_IMPORTED_MODULE_3__["RicechartPage"]
    }];

    var RicechartPageRoutingModule = function RicechartPageRoutingModule() {
      _classCallCheck(this, RicechartPageRoutingModule);
    };

    RicechartPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  function srcAppRicechartRicechartModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _ricechart_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./ricechart-routing.module */
    "./src/app/ricechart/ricechart-routing.module.ts");
    /* harmony import */


    var _ricechart_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./ricechart.page */
    "./src/app/ricechart/ricechart.page.ts");
    /* harmony import */
    ...
    var _planpage_planpage_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ../planpage/planpage.module */
    "./src/app/planpage/planpage.module.ts");

    var RicechartPageModule = function RicechartPageModule() {
  ...
  function srcAppRicechartRicechartPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-content {\n  --padding-bottom: 81px;\n}\n\n.user-profile-icon {\n  width: 50px;\n  background-color: #606060;\n  border-radius: 50px;\n  height: 50px;\n  line-height: 50px;\n  margin-left: 15px;\n  margin-top: 10px;\n}\n\n.user-profile-icon span {\n  color: #FFF;\n  font-size: 20px;\n}\n\n.notification img {\n  width: 22px;\n  margin-right: 10px;\n  margin-top: 18px;\n}\n\n.notification .badge {\n  background-color: #ad362d;\n  height: 17px;\n  width: 17px;\n  color: #FFF;\n  border-radius: 50px;\n  display: inline-block;\n  font-size: 12px;\n  text-align: center;\n  line-height: 17px;\n  right: 10px;\n  position: absolute;\n  top: 19px;\n}\n\n.slider img {\n  width: 80px;\n}\n\n.title-padding {\n  padding-top: 0px;\n  padding-bottom: 0px;\n}\n\n.title-padding h2 {\n  margin: 0px;\n}\n\n.price-table {\n  background-color: #FFF;\n}\n\n.price-table table {\n  width: 100%;\n  margin-top: 6px;\n}\n\n.price-table table thead tr {\n  height: 34px;\n  font-size: 12px;\n  background-color: #eeeeee !important;\n}\n\n.price-table table thead tr th {\n  background-color: #eeeeee !important;\n  border-right: 1px solid #dfdfdf;\n}\n\n.price-table table tbody tr {\n  height: 35px;\n}\n\n.price-table table tbody tr td {\n  font-size: 12px;\n  border-bottom: 1px solid #dfdfdf;\n  border-right: 1px solid #dfdfdf;\n}\n\n.table-row {\n  margin-top: 0px;\n  padding-top: 0px;\n}\n\n.table-row tr td {\n  text-align: center;\n}\n\n.wrapper {\n  position: relative;\n  overflow: auto;\n  padding: 0px;\n  box-shadow: 1px 4px 6px #CCC;\n  border-radius: 3px;\n}\n\n.sticky-col {\n  position: sticky;\n  position: -webkit-sticky;\n  background-color: white;\n  border-right: 1px solid #dfdfdf;\n  z-index: 99999;\n}\n\n.first-col {\n  width: auto;\n  min-width: 66px;\n  max-width: 100px;\n  left: 0px;\n  border-right: 1px solid #dfdfdf;\n}\n\n.second-col {\n  width: 150px;\n  min-width: 150px;\n  max-width: 150px;\n  left: 100px;\n}\n\n.red-price {\n  color: red;\n  font-weight: 600;\n}\n\n.green-price {\n  color: green;\n  font-weight: 600;\n}\n\n.black-price {\n  color: #000;\n  font-weight: 600;\n}\n\n.bg-white {\n  background-color: #FFF;\n}\n\n.transport-card {\n  margin-top: -5px;\n}\n\n.trasnport-image {\n  width: 50px;\n}\n\n.dotted-border {\n  border-bottom: 2px dotted #000;\n  margin: 19px auto;\n  width: 81%;\n}\n\n.transport-state {\n  margin-top: -10px;\n  display: block;\n  font-size: 13px;\n}\n\n.price-col {\n  color: #000;\n  font-size: 13px;\n  padding-top: 14px;\n}\n\n.transport-row {\n  border-bottom: 1px solid #CCC;\n}\n\n.ripple-parent {\n  position: relative;\n  overflow: hidden;\n}\n\n.scroll-arrow {\n  width: 100%;\n  padding-top: 4px;\n  font-size: 18px;\n}\n\n.sntc-slider img {\n  width: 250px;\n  margin-top: 2px;\n  margin-left: -16px;\n}\n\n.sntc-slider h1 {\n  font-size: 37px;\n  margin: 0px;\n  padding: 0px;\n  margin-top: 25px;\n  color: green;\n}\n\n.sntc-slider p {\n  margin: 0px;\n  padding: 0px;\n}\n\n.type-columns {\n  min-width: 75px;\n}\n\n.slide-image {\n  width: 90%;\n  border-radius: 6px;\n}\n\n.rice-gallery {\n  padding-top: 0px;\n}\n\n.logo-text {\n  font-family: \"Monotype Corsiva\";\n}\n\n.header-segment {\n  height: 50px;\n  --padding-end: 0px;\n  margin-right: 0px;\n  margin: 0 auto;\n}\n\n.header-segment ion-segment-button {\n  --indicator-color: transparent !important;\n  --indicator-color-checked: transparent !important;\n  height: 0px;\n  border-radius: 0px;\n  min-height: 31px;\n  margin-left: 2px;\n  margin-right: 2px;\n  width: auto;\n  color: #000;\n  font-size: 12px;\n  border: 2px solid #92b243;\n}\n\n.header-segment ion-segment-button.segment-button-checked {\n  background-color: #FFF;\n}\n\n.header-segment ion-segment-button.segment-button-checked ion-label {\n  margin: 0px;\n  padding: 0px;\n  color: green;\n  font-weight: 600;\n  font-size: 100%;\n}\n\n.header-segment ion-label.sc-ion-label-md-s md {\n  font-size: 60%;\n}\n\n.header-segment ion-label {\n  margin: 0px;\n  padding: 0px;\n  color: #000;\n  font-weight: 600;\n  font-size: 100%;\n}\n\n.viewtrans {\n  height: 0px;\n  margin-top: 8px;\n  border-radius: 100px;\n  min-height: 36px;\n  margin-left: 2px;\n  margin-right: 2px;\n  box-shadow: -1px 1px 9px 0px #CCC;\n  width: 33%;\n  color: #000;\n  font-size: 12px;\n  text-decoration: none;\n  padding: 10px;\n}\n\n.center {\n  text-align: center;\n}\n\n.center p {\n  padding: 15px 0px 15px 0px;\n  margin: 0;\n  margin-bottom: 20px;\n  background: #eeeeee;\n}\n\n.rice-gallery {\n  padding-bottom: 0;\n}\n\n.pt0 {\n  padding-top: 0;\n}\n\n.pb0 {\n  padding-bottom: 0;\n}\n\n.scroll-arrow {\n  position: absolute;\n  margin-top: 1%;\n}\n\n.scroll-arrow .lefticon {\n  position: absolute;\n  left: 10px;\n  z-index: 999999;\n  color: white;\n  padding: 2px;\n  top: 0px;\n  width: 18px;\n}\n\n.scroll-arrow .righticon {\n  position: absolute;\n  right: 10px;\n  z-index: 999999;\n  color: white;\n  padding: 2px;\n  top: 0px;\n  width: 18px;\n}\n\n.ricetitle {\n  font-size: 20px;\n}\n\n.basmatiState {\n  margin: 0 30px;\n}\n\ntable {\n  width: 100%;\n}\n\ntable .right {\n  text-align: right;\n}\n\ntable .left {\n  text-align: left !important;\n}\n\n.pl-10 {\n  padding-left: 10px;\n}\n\n.p05 {\n  padding: 0px 5px;\n}\n\n.green {\n  color: #92b243;\n}\n\n.red {\n  color: red;\n}\n\n.grey {\n  color: grey;\n}\n\n.dashboard table, .dashboard thead, .dashboard th, .dashboard tr, .dashboard td, .dashboard td {\n  border: 0px;\n}\n\n.dashboard table thead, .dashboard table tbody {\n  background: transparent !important;\n  background-color: transparent !important;\n  border-bottom: 2px solid #ededed !important;\n}\n\n.dashboard table thead tr, .dashboard table tbody tr {\n  background: transparent !important;\n  background-color: transparent !important;\n  border-bottom: 2px solid #ededed !important;\n}\n\n.dashboard table thead tr th, .dashboard table tbody tr th {\n  background: transparent !important;\n  background-color: transparent !important;\n  border-right: 0px !important;\n}\n\n.dashboard table thead tr td, .dashboard table tbody tr td {\n  border-right: 0px !important;\n}\n\n.ricechart ul {\n  list-style: none;\n  display: inline-flex;\n}\n\n.ricechart ul li {\n  padding: 5px 15px;\n}\n\nion-content {\n  --background: #FFFBD6 !important;\n  background: #FFFBD6 !important;\n}\n\n.highcharts-axis-labels.highcharts-xaxis-labels {\n  display: none !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppRicechartRicechartPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../components.service */
    "./src/app/components.service.ts");
    /* harmony import */


    var _planpage_planpage_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var RicechartPage = /*#__PURE__*/function () {
      function RicechartPage(navCtrl, apiser, loading, compSer, ModelCtrl) {
        ...
        this.compSer.chartInterval.subscribe(function (res) {// this.selectedChartData = res;
      ...
      _createClass(RicechartPage, [{
        ...
        value: function getChartInterval() {
          ...
          this.apiser.getChartInterval().then(function (res) {
            _this3.chartIntervals = res.chartinterval;
          });
        }
      }, {
        key: "payWithRazor",
        value: function payWithRazor() {
          ...
          var cancelCallback = function cancelCallback(error) {
            _this4.compSer.chartInterval.next("15_Days");
          };
        ...
        value: function getCartData(timeLimit) {
          ...
          if (this.selectedChartData == "15_Days") {
            ...
            this.apiser.getChartData(state, riceType, this.rice, timeLimit).then(function (res) {
              ...
              var myChart = highcharts__WEBPACK_IMPORTED_MODULE_3__["chart"]('highcharts', {
                chart: {
                  backgroundColor: '#FFFBD6',
                  type: 'line'
                },
                ...
                series: [{
                  type: 'line',
                  name: _this5.rice + ' - ' + _this5.changeName(riceType),
                  data: priceArray
                }]
              });
              setTimeout(function () {
          ...
          if (this.selectedChartData != "15_Days" && localStorage.getItem('chartInt') == 'true') {
            ...
            this.apiser.getChartData(_state, _riceType, this.rice, timeLimit).then(function (res) {
              ...
              var myChart = highcharts__WEBPACK_IMPORTED_MODULE_3__["chart"]('highcharts', {
                ...
                series: [{
                  type: 'line',
                  name: _this5.changeName(_riceType),
                  data: priceArray
                }]
              });
              setTimeout(function () {
    ...
    RicechartPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      /*! raw-loader!./ricechart.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ricechart/ricechart.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./ricechart.page.scss */
      "./src/app/ricechart/ricechart.page.scss"))["default"]]
...
//# sourceMappingURL=ricechart-ricechart-module-es5.js.map
...
class HighchartsGantt {
    ...
    init(el) {
        if (!this.ref) {
            ganttChart(el.nativeElement, this.options, (/**
             * @param {?} chart
             * @return {?}
             */
            chart => {
...
export { Chart, ChartDirective, ChartModule, HIGHCHARTS_MODULES, HighchartsGantt, MapChart, StockChart, ChartService as ɵa };
